...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of LD1Task */
  LD1TaskHandle = osThreadNew(StartLD1Task, NULL, &LD1Task_attributes);

  /* creation of LD2Task */
  LD2TaskHandle = osThreadNew(StartLD2Task, NULL, &LD2Task_attributes);
...
/* USER CODE BEGIN Header_StartLD1Task */
/**
  * @brief  Function implementing the LD1Task thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_StartLD1Task */
void StartLD1Task(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
...
/* USER CODE BEGIN Header_StartLD2Task */
/**
* @brief Function implementing the LD2Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartLD2Task */
void StartLD2Task(void *argument)
{
  /* USER CODE BEGIN StartLD2Task */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
